...
public class profile1002 extends JFrame implements ActionListener{
	...
	profile1002()
	{
		...
		JTextField jl3= new JTextField("1002"); 
		...
		try{
			...
			Scanner sc = new Scanner(new File("email1002.txt"));
			sc.useDelimiter("[,\n]");
	...
	public void actionPerformed(ActionEvent ev)
	{
		...
		if(msg.equals("Back")){
			...
			try{
				...
				FileWriter fwe = new FileWriter("email1002.txt");
				jl7.write(fwe);
				fwe.write(",");
				jl8.write(fwe);
				fwe.write("\n");
	...
	{
		new profile1002().setVisible(true);
	}
